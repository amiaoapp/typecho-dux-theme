...
?>
    ...
    ?>">
        <?php
            ...
            $avatar = $host . $url . $hash . '?s=' . $size . '&r=' . $rating . '&d=robohash';
        ?>
...
echo $author;
 ?>
</span> (<?php $comments->date('Y-m-d'); ?>) <?php $comments->reply('回复'); ?>
            </div>
        </div>
...
<?php endif; ?>
                ...
                <div class="comt-box">
                    <textarea placeholder="在此评论吧， 有趣的人儿." class="input-block-level comt-area" name="text" id="comment" cols="100%" rows="3" tabindex="1" ></textarea>
                    <div class="comt-ctrl">
