...
<script>
     (adsbygoogle = window.adsbygoogle || []).push({
          google_ad_client: "ca-pub-2605666858224038",
          enable_page_level_ads: true
     });
</script>


<meta name="google-site-verification" content="o8KXY1vdbvfzhqdnRw8-rKTBIaOXSnmGjEgMku6eGyM" />
<!-- Global site tag (gtag.js) - Google Analytics -->     
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-125799349-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-125799349-1');
</script>
...
(function() {
  ...
  hm.src = "https://hm.baidu.com/hm.js?6ebeb780c756c5ea5b881afcb5474799";
  ...
  s.parentNode.insertBefore(hm, s);
    ...
    <link rel="icon" href="https://www.appmews.com/usr/themes/image/miao.png" sizes="32x32"/>
    <link rel="icon" href="https://www.appmews.com/usr/themes/image/miao.png" sizes="192x192"/>
	...
	<?php $this->header('generator=&template=&pingback=&xmlrpc=&wlw=&rss1=&rss2=&atom='); ?>
       ...
       <meta name="keywords" content="APP,APP喵,软件,喵,喵帕斯,资源,SAP,SSR,绘画">
...
<?php if($children): ?>
	<a href="<?php $cats->permalink()?>"><?php echo $b_arr[$i]; ?> <?php $cats->name()?></a>
	<ul class="sub-menu">
		<?php foreach($children as $mid){
			$child = $cats->getCategory($mid);
			
			echo '<li class="menu-item menu-item-type-taxonomy menu-item-object-category"><a href="' . $child["permalink"] . '">' . $child["name"] . '</a></li>';
		}
		?>
	</ul>
<?php $i++; ?>
<?php elseif(!$cats->parent): ?>
...
<?php endwhile; ?>
  ...
  <div class="topbar">
    ...
    <li class="menusns">
        <a style="color:red;" href="javascript:;">关注本站<i class="fa fa-angle-down"></i></a>
        <ul class="sub-menu"><?php /* 社交类二级菜单 */ ?>
          ...
          <?php if ($this->options->socialtwitter): ?><li>
            <a target="_blank" rel="external nofollow" href="<?php $this->options->socialtwitter(); ?>">
              <i class="fa fa-play-circle-o"></i>B站</a>
          </li><?php endif; ?>
          <?php if ($this->options->socialzhihu): ?><li>
            <a target="_blank" rel="external nofollow" href="<?php $this->options->socialzhihu(); ?>">
              <i class="fa fa-quote-right"></i>知乎</a>
          </li><?php endif; ?>
          <li>
	...
	<a class="signup-loader" href="<?php $this->options->logoutUrl(); ?>"><?php _e('退出'); ?></a><?php else: ?><a class="signin-loader" href="<?php $this->options->adminUrl('login.php'); ?>"><?php _e('Hi, 请登录'); ?></a>&nbsp; &nbsp;
